...
var Config = /** @class */ (function () {
    ...
    Config.prototype.apireturn = function () {
        return apikey;
    };
    return Config;
}());
...
var AppRoutingModule = /** @class */ (function () {
    ...
    AppRoutingModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forRoot(routes /*,{ preloadingStrategy : PreloadAllModules}*/),
            ],
...
module.exports = "<ion-app>\n  <ion-split-pane>\n    <!--  our side menu  -->\n    <ion-menu>\n      <ion-header>\n        <ion-toolbar>\n          <ion-title>Menu</ion-title>\n        </ion-toolbar>\n      </ion-header>\n      <ion-content>\n        <ion-list>\n          <ion-menu-toggle auto-hide=\"false\" *ngFor=\"let p of pages\">\n            <app-menu-item class=\"item-icon-left\" [link]=\"p\">\n            </app-menu-item>\n          </ion-menu-toggle>\n        </ion-list>\n      </ion-content>\n      <ion-footer>\n          <ion-list>\n            <ion-item class=\"log-out\" (click)=\"LogOutClicked()\">Logout</ion-item>\n          </ion-list>\n        </ion-footer>\n    </ion-menu>\n    <!-- the main content -->\n    <ion-router-outlet main></ion-router-outlet>\n  </ion-split-pane>\n</ion-app>"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, authService, router, mnCtrl) {
...
module.exports = "active-item {\n  border-left: 8px solid var(--ion-color-primary); }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _modal_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modal.page */ "./src/app/modal/modal.page.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ModalPageModule = /** @class */ (function () {
    ...
    ModalPageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            entryComponents: [_modal_page__WEBPACK_IMPORTED_MODULE_5__["ModalPage"]],
...
module.exports = "<ion-header>\n    <!-- <script src=\"C:\\Users\\Roggh\\Desktop\\working_src\\node_modules\\ion-autocomplete\\distion-autocomplete.js\"></script> -->\n    <!-- <link href=\"C:\\Users\\Roggh\\Desktop\\working_src\\node_modules\\ion-autocomplete\\distion-autocomplete.css\" rel=\"stylesheet\"> -->\n    <ion-toolbar>\n      <ion-title>\n        SelectRoute!\n      </ion-title>\n      <ion-buttons slot=\"end\">\n          <div class=\"bar bar-header\">\n              <ion-button align=\"right\" class=\"button button-clear button-positive\" (click)=\"closeModal()\"><ion-icon name=\"arrow-round-back\"></ion-icon></ion-button>\n            </div>\n        </ion-buttons>\n    </ion-toolbar>\n  </ion-header>\n\n<ion-content padding align=\"center\">\n  <!-- <form align=\"center\" name=\"modal\" >\n    <ion-searchbar placeholder=\"Your Location\" animated ></ion-searchbar>\n    <ion-searchbar ion-autocomplete type=\"text\" readonly=\"readonly\" class=\"ion-autocomplete\" autocomplete=\"off\" max-selected-items=\"1\" placeholder=\"Destination\" animated name=\"dest\" [(ngModel)]=\"dest\" (ionChange)=\"doSomething($event)\"></ion-searchbar>\n    <ion-searchbar  placeholder=\"Destination\"  [(ngModel)]=\"stlist\"  (ionChange)=\"doSomething($event)\"></ion-searchbar> -->\n    <!-- <ion-searchbar [(ngModel)]=\"YourLoc\" value=\"{{src.Address}}\" (ionChange)=\"doNothing($event)\"></ion-searchbar> -->\n    <div *ngIf=\"!Srcset\" class=\"spinner-container\">\n        <ion-searchbar placeholder=\"Source\" [(ngModel)]=\"Source\"  (ionChange)=\"doNothing($event)\"></ion-searchbar>\n    </div>\n    <div *ngIf=\"Srcset\" class=\"spinner-container\">\n            <ion-text color=\"secondary\"><h6>Source Station:{{src.Address}}</h6></ion-text>\n        </div>\n        <div *ngIf=\"searchingsrc\" class=\"spinner-container\">\n            <ion-spinner></ion-spinner>\n        </div>\n             <ion-list>\n            <ion-item *ngFor=\"let st of srclist\" (click)=\"setSrc(st)\" >\n                {{st.Landmark}},{{st.Address}}\n            </ion-item>\n        </ion-list>\n    <div *ngIf=\"!DestSet\" class=\"spinner-container\">\n    <ion-searchbar placeholder=\"Destination\" [(ngModel)]=\"Destination\"  (ionChange)=\"doSomething($event)\"></ion-searchbar>\n</div>\n<div *ngIf=\"DestSet\" class=\"spinner-container\">\n        <ion-text color=\"secondary\"><h6>Destination Station:{{finalDest.Address}}</h6></ion-text>\n    </div>\n    <div *ngIf=\"searching\" class=\"spinner-container\">\n        <ion-spinner></ion-spinner>\n    </div>\n         <ion-list>\n        <ion-item *ngFor=\"let st of stlist\" (click)=\"setDest(st)\" >\n            {{st.Landmark}},{{st.Address}}\n        </ion-item>\n    </ion-list>\n    <ion-button (click)=\"NavNow()\">\n        <ion-icon name=\"paper-plane\"></ion-icon>\n    </ion-button>\n  <!-- </form> -->\n</ion-content> \n\n"
...
module.exports = "page-home .spinner-container {\n  width: 100%;\n  text-align: center;\n  padding: 10px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _route_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../route.service */ "./src/app/route.service.ts");
...
var ModalPage = /** @class */ (function () {
    function ModalPage(nav, modalCtrl, geolocation, formsmodule, reactive, routeservice, alertController, global_var) {
        this.nav = nav;
    ...
    ModalPage.prototype.NavNow = function () {
        this.modalCtrl.dismiss(this.data);
        console.log("Submited");
    };
    ModalPage.prototype.doNothing = function ($event) {
        var _this = this;
        console.log($event.target.value);
        //console.log($event.target.length);  
        if ($event.target.value.length > 1) {
            this.searching = true;
            this.routeservice.Search($event.target.value).subscribe(function (res) {
                //this.router.navigateByUrl('/login');
                _this.srclist = res;
                //  var i;var lt=Object.keys(res).length;  
                console.log(_this.srclist);
                _this.searchingsrc = false;
    ...
    ModalPage.prototype.doSomething = function ($event) {
        var _this = this;
        console.log($event.target.value);
        //console.log($event.target.length);  
        if ($event.target.value.length > 1) {
    ...
    ModalPage.prototype.setDest = function (finald) {
    ...
    ModalPage.prototype.setSrc = function (finald) {
        this.src = finald;
        this.Srcset = true;
        this.srcbool = true;
    ...
    ModalPage.prototype.presentAlert = function () {
                    ...
                    case 0: return [4 /*yield*/, this.alertController.create({
                            ...
                            buttons: [{ text: 'Ok',
                                    handler: function () {
                                        ...
                                        _this.modalCtrl.dismiss(_this.data);
                                    } }]
                        })];
                    case 1:
                        alert = _a.sent();
    ...
    ], ModalPage.prototype, "mapElement", void 0);
    ModalPage = __decorate([
        ...
        __metadata("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["NavController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["ModalController"], _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_2__["Geolocation"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _route_service__WEBPACK_IMPORTED_MODULE_4__["RouteService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["AlertController"], _global_var_service__WEBPACK_IMPORTED_MODULE_5__["GlobalVarService"]])
    ], ModalPage);
    return ModalPage;
}());
...
var RouteService = /** @class */ (function () {
    function RouteService(http, alertController) {
        this.http = http;
        this.alertController = alertController;
        this.Json1 = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"]("abc");
        this.currentJson = this.Json1.asObservable();
    }
    RouteService.prototype.changeJson = function (obj) {
        this.Json1.next(obj);
    };
    RouteService.prototype.Source = function (latitude, longitude) {
        var _this = this;
        var data = {
            lat: latitude,
            longi: longitude
    ...
    RouteService.prototype.Search = function (credentials) {
        var _this = this;
    ...
    RouteService.prototype.showAlert = function (msg) {
    ...
    RouteService.prototype.TripRecord = function (data) {
        var _this = this;
    ...
    RouteService = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["AlertController"]])
    ], RouteService);
    return RouteService;
}());
...
/* harmony import */ var _global_var_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../global-var.service */ "./src/app/global-var.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AuthService = /** @class */ (function () {
    function AuthService(http, helper, storage, plt, alertController, GlobalVarService) {
        var _this = this;
        this.http = http;
        this.helper = helper;
        ...
        // url = environment.url;
        this.user = null;
        this.authenticationState = new rxjs__WEBPACK_IMPORTED_MODULE_6__["BehaviorSubject"](false);
        ...
        this.storage.get(TOKEN_KEY).then(function (token) {
            if (token) {
                ...
                if (!isExpired) {
                    ...
                    _this.GlobalVarService.LoggedUser = null;
                }
            }
        });
    };
    ...
    AuthService.prototype.login = function (credentials) {
        ...
        return this.http.post('http://ec2-52-66-169-149.ap-south-1.compute.amazonaws.com:80/api/first/login', credentials)
            ...
            _this.GlobalVarService.LoggedUser = res["Name"];
            _this.authenticationState.next(true);
    ...
    AuthService = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_3__["JwtHelperService"], _ionic_storage__WEBPACK_IMPORTED_MODULE_4__["Storage"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_0__["Platform"], _ionic_angular__WEBPACK_IMPORTED_MODULE_0__["AlertController"], _global_var_service__WEBPACK_IMPORTED_MODULE_7__["GlobalVarService"]])
    ], AuthService);
    return AuthService;
}());
...
module.exports = __webpack_require__(/*! C:\Users\Roggh\Desktop\clientTraining\src\main.ts */"./src/main.ts");
